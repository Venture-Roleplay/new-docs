...
#### 2.1.1 - The Ranking Structure

The department of Law Enforecement will be considered a uniform department. The ranks of the police departments will be consistant through out. The rank you are given will be valid in all departments, this creats a flow of the three departments. If you apply for Law Enforcemt at Venture RP and you are accepeted, you will be granted the Probationary rank and access to all three departments in there respective Probationary positions. (Probatinary Trooper, Probationary Officer, Probationary Deputy) 

Probationary - as a Probationary you main goals should be to learn as much as possible about how the department runs as well as the expectations of professionalism at Venture RP's LEO Deaprtment. You should be maintaining a high level of repect for the Feild Training Officers (FTO) as they will be the ones to teach you how to be succsessful in Venture RP. You will be not allowed to patrol on your own, only with a certified FTO. You must complete a series of FTO ride alongs before you can be promoted to a stand alone rank (Trooper, Officer, Deputy).  
