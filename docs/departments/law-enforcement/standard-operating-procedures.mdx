...
<<<<<<< Updated upstream
For example, a probationary will directly report to a Field training officer. Even though any supervisor has the experience for this duty, you will report to the ones who are FTO certified. They hae gone through additional training and gained special access to help you out. Some supervisors may have other duties, hence why they have not opted into this program. Note: This does not mean FTOs have authority over other supervisors.

Further explanations based on this topic will be answered in the next section.
...
Due to there being 3 separate names for this rank, Trooper will be used as example, however all LEO departments operate the same
