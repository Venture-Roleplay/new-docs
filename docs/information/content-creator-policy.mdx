...
Our official discord link can be found and copied below. Please ensure that you are using the correct link when promoting our community.

```
https://dsc.gg/venturerp
```
